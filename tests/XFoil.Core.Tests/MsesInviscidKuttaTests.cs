...
public class MsesInviscidKuttaTests
{
    ...
    public void ApplyKuttaRow_WritesExpectedStructure()
    {
        ...
        rhs[n] = 99.0;
        ThesisClosurePanelSolver.ApplyKuttaRow(mat, rhs, n);
        for (int k = 0; k < n + 1; k++)
        {
    ...
    public void TrailingEdgeGap_Naca0012_IsSmallButNonZero()
    {
        ...
        double gap = ThesisClosurePanelSolver.TrailingEdgeGap(pg);
    ...
    public void TrailingEdgeGap_ScalesWithThickness()
    {
        ...
        // 4-digit generation.
        var gen = new XFoil.Core.Services.NacaAirfoilGenerator();
        var gap06 = ThesisClosurePanelSolver.TrailingEdgeGap(
            ThesisClosurePanelSolver.DiscretizePanels(
                gen.Generate4DigitClassic("0006", pointCount: 101)));
        var gap12 = ThesisClosurePanelSolver.TrailingEdgeGap(
            ThesisClosurePanelSolver.DiscretizePanels(
                gen.Generate4DigitClassic("0012", pointCount: 101)));
        var gap24 = ThesisClosurePanelSolver.TrailingEdgeGap(
            ThesisClosurePanelSolver.DiscretizePanels(
    ...
    public void SolveInviscid_BluntTE_StillProducesPhysicalCL()
    {
        ...
        var r = ThesisClosurePanelSolver.SolveInviscid(pg, 1.0, a, 1.0);
