...
/// </summary>
public class ThesisClosureBoundaryLayerResidualTests
{
    [Fact]
    public void MomentumResidual_ConstantState_IsApproxZero()
    {
        ...
        double r = ThesisClosureBoundaryLayerResidual.MomentumResidual(
    ...
    public void MomentumResidual_BalancedGrowth_IsApproxZero()
    {
        ...
        double ue = 1.0;
        double nu = 1e-6;
        double hkVal = XFoil.ThesisClosureSolver.Closure.ThesisClosureRelations.ComputeHk(h, 0.0);
        double reT = ue * theta0 / nu;
        double cf = XFoil.ThesisClosureSolver.Closure.ThesisClosureRelations.ComputeCfTurbulent(
            hkVal, reT, 0.0);
        double dx = 0.01;
    ...
    public void LagResidual_AtEquilibrium_IsApproxZero()
    {
        ...
        double cTauEq = XFoil.ThesisClosureSolver.Closure.ThesisClosureRelations
            .ComputeCTauEquilibrium(hkVal, reT, 0.0);
        double r = ThesisClosureBoundaryLayerResidual.LagResidual(
    ...
    public void MomentumResidual_RejectsNonPositiveStep()
    {
        Assert.Throws<System.ArgumentOutOfRangeException>(
            () => ThesisClosureBoundaryLayerResidual.MomentumResidual(
    ...
    public void SourceConstraintResidual_ExactDerivative_IsZero()
    {
        ...
        double r = ThesisClosureBoundaryLayerResidual.SourceConstraintResidual(
            sigma: expected,
    ...
    {
        Assert.Throws<System.ArgumentOutOfRangeException>(
            () => ThesisClosureBoundaryLayerResidual.SourceConstraintResidual(
    ...
    {
        double r = ThesisClosureBoundaryLayerResidual.ShapeParamResidual(
