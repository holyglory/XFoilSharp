...
// Role in port: Verifies the managed curvature-adaptive PANGEN panel distributor derived from the legacy panel redistribution algorithm.
...
public sealed class CurvatureAdaptivePanelDistributorTests
{
    /// <summary>
    ...
    public void Distribute_Naca0012_ProducesExactlyRequestedNodeCount()
    {
        ...
        CurvatureAdaptivePanelDistributor.Distribute(inputX, inputY, inputCount, panel, 160);
    ...
    public void Distribute_VariousNodeCounts_ProducesCorrectCount(int nodeCount)
    {
        ...
        CurvatureAdaptivePanelDistributor.Distribute(inputX, inputY, inputCount, panel, nodeCount);
