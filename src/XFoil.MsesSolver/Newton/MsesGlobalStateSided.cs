...
/// system. Replaces the R5.0 MsesGlobalState (which used a single
...
///
/// The original MsesGlobalState is kept alongside for the existing
/// P4.6 γ-only gate test.
/// </summary>
public sealed class MsesGlobalStateSided
{
