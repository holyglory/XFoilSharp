...
public sealed class CubicSpline
{
    ...
    // Difference from legacy: The managed helper assembles and solves the spline derivative system using local arrays instead of shared work buffers.
    ...
    // Difference from legacy: The local helper solves the spline system directly instead of delegating to a broader shared solver workspace.
