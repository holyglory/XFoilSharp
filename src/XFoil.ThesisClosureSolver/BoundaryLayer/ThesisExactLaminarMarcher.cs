...
public static class ThesisExactLaminarMarcher
{
        ...
        double machNumberEdge = 0.0)
    {
        ...
        theta[0] = 0.0;
        H[0] = 2.59;
        HStar[0] = ThesisClosureRelations.ComputeHStarLaminar(2.59, 1.0);
        ...
        else if (n >= 2 && stations[1] > 0.0 && edgeVelocity[1] > 1e-12)
        {
            ...
            H[1] = 2.59;
            HStar[1] = ThesisClosureRelations.ComputeHStarLaminar(2.59, 1.0);
            startIdx = 2;
        }
        ...
        for (int i = startIdx; i < n; i++)
        {
            ...
            double Hk0 = ThesisClosureRelations.ComputeHk(H[i - 1], machNumberEdge);
            double ReT0 = ue0 * theta[i - 1] / System.Math.Max(kinematicViscosity, 1e-18);
            double Cf0 = ThesisClosureRelations.ComputeCfLaminar(Hk0, ReT0);
            ...
            HStar[i] = ThesisClosureRelations.ComputeHStarLaminar(HkSolve, ReTSolve);
            theta[i] = thetaNew;
        }
        ...
        double nu, double Me)
    {
        ...
        double Residual(double H)
        {
            ...
            double HStar = ThesisClosureRelations.ComputeHStarLaminar(Hk, ReTheta);
            double Cf = ThesisClosureRelations.ComputeCfLaminar(Hk, ReTheta);
            double CD = ThesisClosureRelations.ComputeCDLaminar(Hk, ReTheta);
