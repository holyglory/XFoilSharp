# CurvatureAdaptivePanelDistributor

- File: `src/XFoil.Solver/Services/CurvatureAdaptivePanelDistributor.cs`
- Role: panel distribution generator implementing XFoil's PANGEN algorithm — curvature-weighted Newton equidistribution. (The uniform arc-length seed on the over-sampled Newton grid is an *initial guess*, not the final distribution.)
